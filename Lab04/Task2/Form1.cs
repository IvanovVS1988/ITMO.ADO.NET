...
namespace Task2
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            CustomersTable.Columns.Add("Adress", Type.GetType("System.String"));
        ...
        private void AddRowButton_Click(object sender, EventArgs e)
        {
            ...
            Object[] CustRecord = {"ALFKI", "Alfreds Futterkiste", "Maria Anders", "Sales Representative", "Obere Str. 57",
            "Berlin", "Germany", "030-0076545"};
